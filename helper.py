...
def data_over_time(df, col):
    ...
    nations_over_time = nations_over_time.sort_values('Edition').reset_index(drop=True)
...
def most_successful(df, sport):
    ...
    result = top_athletes.merge(df[['Name', 'Sport', 'region']].drop_duplicates(), on='Name', how='left')
...
def most_successful_countrywise(df, country):
    ...
    result = top_athletes.merge(df[['Name', 'Sport']].drop_duplicates(), on='Name', how='left')
